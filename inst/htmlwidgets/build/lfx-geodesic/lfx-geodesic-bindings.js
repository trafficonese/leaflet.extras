      ...
      function(df, i) {
        ...
        if (options.showMarker) {
          ...
          marker.on('drag', (e) => {
            ...
            (0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.handleEvent)(e, '_geodesic_stats', options, df, i, Geodesic.statistics, updateInfo);
          });
          marker.on('click', (e) => {
            (0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.handleEvent)(e, '_geodesic_click', options, df, i, Geodesic.statistics, updateInfo);
          });
        }
        ...
        Geodesic.on('mouseover', (e) => {
          (0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.handleEvent)(e, '_geodesic_mouseover', options, df, i, Geodesic.statistics, updateInfo);
        });
